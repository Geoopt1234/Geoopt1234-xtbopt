...
- Extreme convergence criteria (`--ohess extreme --acc 0.0001 --alpb SOLVENT --chrg CHARGE --iterations 1000 --cycles 10000 --input gbsagrid=extreme --etemp 300 --gfn 2 -P 1 --strict` as a minimum requirement)
